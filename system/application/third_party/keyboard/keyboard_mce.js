...
(function() {
    ...
    var sp=path.split('/');
    var relativepath=sp['1']; 
    if(location.hostname=='localhost'){
        var uri=location.protocol+'//'+location.hostname+'/'+relativepath;
    }else{
    ...
    this.VKI_imageURI = uri+'/system/application/third_party/keyboard/keyboard.png';  // If empty string, use imageless mode
    ...
    this.VKI_position = function(force) {
        if (self.VKI_target) {
            ...
            if (place || force === true) {
                ...
                self.VKI_keyboard.style.bottom = 0;
