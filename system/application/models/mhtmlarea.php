 ...
 * @category            Class
 * @author		CodeAnalytic Team Web Developer
 * @link		http://docs.codeanalytic.com/models/mhtmlarea
 */ 

class mhtmlarea extends Model {

    var $table = 'ca_htmlarea';
...
/**
 * end of class mhtmlarea.php
 * Location: system/application/models/mhtmlarea.php
 */
?>
