 ...
 * @category            Class
 * @author		CodeAnalytic Team Web Developer
 * @link		http://docs.codeanalytic.com/models/mthird_party
 */
class mthird_party extends Model {
    /**
     * define table use
     * @var type 
     */
    var $table = "ca_third_party";
...
/**
 * end of class mthird_party.php
 * Location: system/application/models/mthird_party.php
 */
?>
