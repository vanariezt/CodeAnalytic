 ...
 * @category            Function
 * @author		CodeAnalytic Team Web Developer
 * @link		http://docs.codeanalytic.com/view/widget_update
 */
?>
<div class="header">
    <h2><?php echo ca_translate("Update configuration setting widget") . " " . $title; ?></h2>
</div>
<form id="config" style="width: 98%; margin-bottom: 10px; float: left; padding: 10px">
    ...
    <div class="footer">
        <label>&nbsp;</label>
        <a class="submit button-red rounded" href="javascript:void(0)" onclick="ca_edit_action('widget/do_update/<?php echo $title ?>',this);"><?php echo ca_translate("update"); ?></a>
