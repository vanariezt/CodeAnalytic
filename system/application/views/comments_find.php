 ...
 * @category            Function
 * @author		CodeAnalytic Team Web Developer
 * @link		http://docs.codeanalytic.com/view/comments_find
 */ 
?>
<div id="search_content">
    ...
    <form id="myform" method="post" onsubmit="return false">
        ...
        <p>
            ...
            <textarea id="s_content" name="s_content" cols="50" rows="2"></textarea> 
        </p>    
        <p id="p_submit">
            ...
            <a id="btn_submit" href="javascript:void(0)" onclick="ca_close_find()">close</a>
        </p> 
    </form> 
    </div>
    <div id="right">
