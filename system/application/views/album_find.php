 ...
 * @category            Function
 * @author		CodeAnalytic Team Web Developer
 * @link		http://docs.codeanalytic.com/view/album_find
 */ 
?>
<div id="search_content">
    ...
    <form id="myform" method="post" onsubmit="return false">
        <p>
            ...
            <input type="text" name="s_name" size="45" class="keyboardInput form_field">
        </p>    
        <p>
            <label><?php echo ca_translate('description');?></label>
            <textarea id="s_content" name="s_description" class="keyboardInput" cols="50" rows="2"></textarea> 
        </p>    
        <p id="p_submit">
